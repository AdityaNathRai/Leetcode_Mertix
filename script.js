document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchUserDetails(username) {
    try {
      ...
      myHeaders.append("x-cors-api-key", "temp_4f1dbceaf64cf7c72e30f7cf56a6e4a4");
    ...
    const cardsData = [
      {
        ...
        value: parsedData.data.matchedUser.submitStats.totalSubmissionNum[0]
          .submissions,
      },
      {
        label: "Overall Easy Submissions",
        value: parsedData.data.matchedUser.submitStats.totalSubmissionNum[1]
          .submissions,
      },
      {
        label: "Overall Medium Submissions",
        value: parsedData.data.matchedUser.submitStats.totalSubmissionNum[2]
          .submissions,
      },
      {
        label: "Overall Hard Submissions",
        value: parsedData.data.matchedUser.submitStats.totalSubmissionNum[3]
          .submissions,
      },
    ];
